 ...
 * across recompositions. On iOS, the app process typically doesn't undergo configuration changes
 * like on Android, so we don't need the more complex state saving mechanism.
 *
