...
class FullComposePreviewActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            MaterialTheme {
                Surface {
                    // CompositionHostedDefaultBoomerangStoreScope provides a BoomerangStore
                    // that is scoped to the composition and persisted across recompositions and configuration changes
